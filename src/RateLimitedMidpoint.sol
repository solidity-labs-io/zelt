...
abstract contract RateLimitedMidpoint {
    ...
    RateLimitMidPoint public rateLimit;
    ...
    constructor(
        ...
        rateLimit.bufferStored = uint112(_bufferCap / 2); /// manually set this as first call to setBufferCap sets it to 0
